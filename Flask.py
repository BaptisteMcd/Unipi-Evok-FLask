...
def test():
   if request.method == "POST":
      ...
      vehicule_number = request.form.get("vehicule-number_form")
      ...
      return redirect('/valider.html?kilometrage={}&vehicule_number={}&parkingspot={}'.format(kilometrage, vehicule_number, parkingspot))
...
def valider():
      ...
      if bon == "true":
         while True:
            try:
                  ...
                  rcvd = redis_client.publish('parking_data', data)
   ...
   return render_template("valider.html",hkilometrage=kilometrage,hvehicule_number=vehicule_number,hparkingspot=parkingspot)
